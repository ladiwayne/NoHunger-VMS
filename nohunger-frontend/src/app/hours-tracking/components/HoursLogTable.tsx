...
const ALL_HOURS: HoursEntry[] = [
  {
    id: 'h-001',
    eventName: 'Mushin Community Food Drive',
    date: 'Mar 17, 2026',
    dateSort: '2026-03-17',
    location: 'Mushin Community Centre',
    checkIn: '08:04 AM',
    checkOut: '—',
    duration: 0,
    durationDisplay: 'In progress',
    eventType: 'Food Packing',
    status: 'in-progress',
    region: 'Lagos State',
  },
  {
    id: 'h-002',
    eventName: 'Oshodi Saturday Pack',
    date: 'Mar 8, 2026',
    dateSort: '2026-03-08',
  ...
  {
    id: 'h-004',
    eventName: 'Apapa Port Logistics Day',
    date: 'Feb 22, 2026',
    dateSort: '2026-02-22',
    location: 'Apapa Community Hall',
    checkIn: '06:45 AM',
    checkOut: '01:15 PM',
    duration: 6.5,
    durationDisplay: '6h 30m',
    eventType: 'Logistics',
    status: 'logged',
    region: 'Lagos State',
  },
  {
    id: 'h-005',
    eventName: 'Lagos Island Distribution',
    date: 'Feb 15, 2026',
    dateSort: '2026-02-15',
  ...
  {
    id: 'h-006',
    eventName: 'Makoko Fishing Community Outreach',
    date: 'Feb 8, 2026',
    dateSort: '2026-02-08',
  ...
  {
    id: 'h-007',
    eventName: 'Lekki Phase 1 Pack Day',
    date: 'Feb 1, 2026',
    dateSort: '2026-02-01',
    location: 'Lekki Community Hall',
    checkIn: '08:00 AM',
    checkOut: '02:00 PM',
    duration: 6.0,
    durationDisplay: '6h 00m',
    eventType: 'Food Packing',
    status: 'logged',
    region: 'Lagos State',
  },
  {
    id: 'h-008',
    eventName: 'Surulere Municipal Kitchen',
    date: 'Jan 25, 2026',
    dateSort: '2026-01-25',
    location: 'Surulere Municipal Hall',
    checkIn: '09:30 AM',
    checkOut: '01:30 PM',
    duration: 4.0,
  ...
  {
    id: 'h-009',
    eventName: 'Victoria Island Outreach',
    date: 'Jan 18, 2026',
    dateSort: '2026-01-18',
  ...
  {
    id: 'h-010',
    eventName: 'Agege Food Bank Saturday',
    date: 'Jan 11, 2026',
    dateSort: '2026-01-11',
    location: 'Agege Stadium Road',
    checkIn: '07:00 AM',
    checkOut: '01:30 PM',
    duration: 6.5,
    durationDisplay: '6h 30m',
  ...
  {
    id: 'h-011',
    eventName: 'Ikorodu Distribution Drive',
    date: 'Jan 4, 2026',
    dateSort: '2026-01-04',
    location: 'Ikorodu Community Centre',
    checkIn: '09:00 AM',
    checkOut: '02:00 PM',
    duration: 5.0,
  ...
  {
    id: 'h-012',
    eventName: 'Alaba Market Logistics',
    date: 'Dec 28, 2025',
    dateSort: '2025-12-28',
    ...
    <div className="bg-card border border-border rounded-2xl shadow-card overflow-hidden">
      ...
      <div className="px-5 py-4 border-b border-border flex items-center gap-3 flex-wrap">
        ...
        <div className="ml-auto flex items-center gap-2 text-[12px] text-muted-foreground font-500 bg-muted px-3 py-2 rounded-xl flex-shrink-0">
          <span className="font-700 text-foreground font-tabular">
            {totalFilteredHours.toFixed(1)} hrs
          </span>
            ...
            {paginated.length === 0 ? (
              <tr>
                <td colSpan={8} className="px-4 py-12 text-center">
                  ...
                  <p className="text-[14px] font-600 text-muted-foreground">
                    No hours sessions found
                  </p>
              ...
              paginated.map((row) => (
                <tr key={row.id} className="hover:bg-muted/40 transition-colors group">
                  ...
                  {/* Date */}
                  <td className="px-4 py-3.5">
                    <p className="text-[13px] font-500 text-foreground whitespace-nowrap">
                      {row.date}
                    </p>
                  </td>
                  ...
                  {/* Location */}
                  <td className="px-4 py-3.5">
                    <p className="text-[12.5px] text-muted-foreground truncate max-w-[160px]">
                      {row.location}
                    </p>
                  </td>
                  ...
                  {/* Check-in */}
                  <td className="px-4 py-3.5">
                    <p className="text-[13px] font-500 text-foreground font-tabular whitespace-nowrap">
                      {row.checkIn}
                    </p>
                  </td>
                  ...
                  <td className="px-4 py-3.5">
                    <p
                      className={`text-[13px] font-500 font-tabular whitespace-nowrap ${row.checkOut === '—' ? 'text-muted-foreground' : 'text-foreground'}`}
                    >
                      {row.checkOut}
                    </p>
                  </td>
                  ...
                  <td className="px-4 py-3.5">
                    <p
                      className={`text-[13px] font-700 font-tabular whitespace-nowrap
      ...
      <div className="px-5 py-3.5 border-t border-border flex items-center justify-between gap-4 flex-wrap bg-muted/20">
        <div className="flex items-center gap-2 text-[12.5px] text-muted-foreground">
          ...
          <span>
            per page · <span className="font-600 text-foreground">{filtered.length}</span> total
            sessions
          </span>
        </div>
